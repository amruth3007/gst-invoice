...
<table> 
<tr><td>Item</td><td><input type="text" name="item" required/></td></tr>
...
<tr><td>Price per Unit:</td><td><input type="text" name="price" required/></td></tr>  
<tr><td>Quantity:</td><td><input type="text" name="quantity" required/></td></tr>
<tr><td>HSN code:</td><td><input type="text" name="hsn_code" required/></td></tr>  
...
<tr><td colspan="2"><input type="submit" value="Save Product"/></td></tr>  
      ...
      <form action="ViewServlet" method="get">
           <input type="submit" value="Proceed to Next Step"   <br>  <br>      
